...
const faqs = [
  ...
  {
    question: "Does every compliance certification take 120 days to get compliance-ready?",
    answer:
      "Not necessarily. The timeline depends on your company's size, current security posture, and the framework you're pursuing. Some companies get compliance-ready faster, others may need more time. We'll provide a realistic timeline based on your specific situation during our scoping call.",
  },
  {
